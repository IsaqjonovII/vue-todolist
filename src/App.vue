...
<template>
  <main
    class="flex flex-col items-center p-4 max-w-md mx-auto bg-slate-100 rounded-md border border-gray-300 my-20"
  >
    <TodoForm @add-todo="handleAddTodo" />

    <ul
      class="border border-gray-300 w-full p-2 gap-2 mt-4 rounded-md"
      v-if="todos.length"
    >
